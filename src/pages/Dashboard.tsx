                  ...
                  <div key={req.id} className="p-4 hover:bg-gray-50 transition-colors">
                    ...
                    <div className="flex flex-col gap-2 mt-3">
                       ...
                       <div className="flex gap-2">
                         <a href={`tel:${req.phone}`} className="flex-1 bg-white hover:bg-gray-50 text-gray-700 border border-gray-200 text-xs font-semibold py-2 rounded-xl transition-colors text-center flex items-center justify-center gap-1">
                           Call
                         </a>
                         <a href={`https://wa.me/${(req.phone || '').replace(/[^0-9]/g, '')}`} target="_blank" rel="noopener noreferrer" className="flex-1 bg-[#25D366]/10 hover:bg-[#25D366]/20 text-[#25D366] border border-[#25D366]/20 text-xs font-semibold py-2 rounded-xl transition-colors text-center flex items-center justify-center gap-1">
                           WhatsApp
                         </a>
                         <button 

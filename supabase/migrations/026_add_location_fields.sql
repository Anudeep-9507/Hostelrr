-- =============================================================================
-- 026_add_location_fields.sql
-- Add area_and_city, state, country to join_requests & residents tables
-- =============================================================================

-- Add location fields to join_requests
ALTER TABLE public.join_requests
  ADD COLUMN IF NOT EXISTS area_and_city TEXT,
  ADD COLUMN IF NOT EXISTS state TEXT,
  ADD COLUMN IF NOT EXISTS country TEXT DEFAULT 'India';

-- Add location fields to residents
ALTER TABLE public.residents
  ADD COLUMN IF NOT EXISTS area_and_city TEXT,
  ADD COLUMN IF NOT EXISTS state TEXT,
  ADD COLUMN IF NOT EXISTS country TEXT DEFAULT 'India';

COMMENT ON COLUMN public.join_requests.area_and_city IS 'Area and city of residence';
COMMENT ON COLUMN public.join_requests.state IS 'State of residence';
COMMENT ON COLUMN public.join_requests.country IS 'Country of residence, defaults to India';

COMMENT ON COLUMN public.residents.area_and_city IS 'Area and city of residence';
COMMENT ON COLUMN public.residents.state IS 'State of residence';
COMMENT ON COLUMN public.residents.country IS 'Country of residence, defaults to India';

-- Update create_join_request function to accept location fields
...
BEGIN
  ...
  INSERT INTO public.join_requests (
    ...
    aadhar_number, photo_path, aadhar_document_path, area_and_city, state, country
  )
  VALUES (
  ...
  PERFORM public._log_activity(
    ...
    'join_request',
    v_request_id,
    jsonb_build_object('name', p_name, 'phone', p_phone, 'preferred_room', p_preferred_room, 'area_and_city', p_area_and_city, 'state', p_state, 'country', p_country)
  );
...
-- Update add_resident function to accept location fields
...
-- Update approve_join_request function to pass location fields to add_resident
